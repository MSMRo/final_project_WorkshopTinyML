...
#if defined(ARDUINO_SAMD_MsKRWIFI1010) || defined(ARDUINO_SAMD_NANO_33_IOT) || defined(ARDUINO_AVR_UNO_WIFI_REV2)
  #include <WiFiNINA.h>
...
/* Includes ---------------------------------------------------------------- */
#include <ws-brasil-final-project_inferencing.h>
...
int        port     = 1883;
const char topic[]  = "tinyml-brasil/data";
...
// This part is the core
    ...
    for (size_t ix = 0; ix < EI_CLASSIFIER_LABEL_COUNT; ix++) {
        ...
        message += String(result.classification[ix].label) + ": " + String(result.classification[ix].value, 5) + "\r\n";
    }
    snprintf (msg, MSG_BUFFER_SIZE, "%s", message.c_str());
